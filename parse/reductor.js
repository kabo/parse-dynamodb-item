...
module.exports = (item, parse) => (reduced, prop) => {
    ...
    else if (prop === 'L') return parseList(item[prop], parse);
    else if (prop === 'SS' || prop === 'NS') return parseSet(item[prop]);
    ...
    else if (item[prop].L) reduced[prop] = parseList(item[prop].L, parse);
